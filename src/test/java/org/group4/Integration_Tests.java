 ...
 public class Integration_Tests {
     ...
     void Customer_Reservation_And_Arrival_Happy_Path() {
         ...
         Reservation reservation = assertDoesNotThrow(() -> restaurant.makeReservation(customer, 4, LocalDateTime.parse("2024-05-24T19:00:00"), reservationCredits));

         // customer_arrival,CUST001,REST001,2024-05-24,18:50,19:00
         ArrivalStatus status = restaurant.customerArrives(customer, LocalDate.parse("2024-05-24"), LocalTime.parse("18:50:00"), LocalTime.parse("19:00:00"));
     ...
     @Test
     void Customer_Reservations_And_Arrival_Happy_Path() {
         Customer customer = customers.get("CUST001");
         Restaurant restaurant = restaurants.get("REST001");
